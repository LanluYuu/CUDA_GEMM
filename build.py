...
def main():
    ...
    run_command(f"cmake -DK_VERSION='{args.version}' -DREF_TYPE='{args.ref}' -DDATA_TYPE='{args.dt}' -DSOURCE_FILE=gemm_v{args.version}.cu -B '{build_dir}' .")
    print(f"cmake -DK_VERSION='{args.version}' -DREF_TYPE='{args.ref}' -DDATA_TYPE='{args.dt}' -DSOURCE_FILE=gemm_v{args.version}.cu -B '{build_dir}' .")
